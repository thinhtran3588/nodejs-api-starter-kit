...
describe('AddRoleToUserGroupCommandHandler', () => {
  let handler: AddRoleToUserGroupCommandHandler;
  ...
  beforeEach(() => {
    ...
    handler = new AddRoleToUserGroupCommandHandler(
      mockAuthorizationService,
      mockUserGroupValidatorService,
      mockRoleRepository,
      mockUserGroupRepository,
  ...
  describe('execute - happy path', () => {
    it('should add role to user group', async () => {
      ...
      const command: AddRoleToUserGroupCommand = {
      ...
      vi.mocked(mockUserGroupRepository.addRole).mockResolvedValue();
  ...
  describe('execute - validation errors', () => {
    ...
    it('should throw ValidationException when role is already in group', async () => {
      const userGroup = new UserGroup({
        id: userGroupId,
        name: 'Test Group',
        version: 0,
